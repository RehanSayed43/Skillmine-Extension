report 50109 "Purchase Register1"
{
    ...
    //JAGUAR REPORT-PURCHASE REGISTER
    ...
    dataset
    {
        ...
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
            ...
            column(Location_State_Code; "recStateDesc") { }
            ...
            begin
                ...
                recstate.Reset();
                recstate.SetRange(Code, Vendor."State Code");
                if recstate.FindFirst() then begin
                    recstateDesc2 := recstate.Description;
                end;
                // Vendor.Reset();
                // Vendor.SetRange("No.", "Purch. Inv. Header"."No.");
                // if Vendor.FindFirst() then begin
                //     VendorStateCode := Vendor."State Code";
                // end;
                // "Purch. Inv. Header".Reset();
                // "Purch. Inv. Header".SetRange("No.", "Purch. Inv. Line"."No.");
                // if "Purch. Inv. Header".FindFirst() then begin
                //     ItemNo := "Purch. Inv. Line"."No.";
                // end;

                // if "Purch. Inv. Header".FindFirst() then
                // begin
                //     DimensionValueEntry.Reset();
                //     DimensionValueEntry.SetFilter("Dimension Code",'=%1','BRAND');
                //     DimensionValueEntry.SetFilter("Dimension Value Code",pur);
                // end;
        ...
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            column(Document_Datcre; "Document Date")
            {
